...
public class BarrioController {
		...
		public String crearBarrio(@Valid @ModelAttribute("barrio") Barrio barrio, BindingResult result,
				ModelMap model) {
		...
		public String postEditarBarrio(@Valid @ModelAttribute("barrio") Barrio barrio, BindingResult result, ModelMap model) {
			if(result.hasErrors()) {
				//si da error el objeto recibido se vuelve a enviar a la vista
				model.addAttribute("barrio", barrio);			
				model.addAttribute("formTab", "active");
